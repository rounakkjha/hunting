...
export default function StrategyBoard({ items, onAdd, onDelete, onToggle, onEdit, onReorder }: StrategyBoardProps) {
  ...
  return (
    <div className="relative group">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-violet-500/20 to-violet-600/20 rounded-3xl opacity-0 group-hover:opacity-100 blur transition duration-500 hidden sm:block" />
